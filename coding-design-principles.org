...
** Design Patterns
Cheat sheets:
- [[https://github.com/paymaan/tut-notes/blob/master/pdfs/Design%2520Patterns%2520-%2520DZone%2520-%2520Refcardz.pdf][dzone design patterns ref card (web site)]]
...
- In general, prefer composition to inheritance:
  ...
  - In inheritance, we cna't change implementation at run-time like we can with compisition
